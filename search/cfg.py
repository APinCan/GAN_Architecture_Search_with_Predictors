...
def parse_args():
    ...
    parser.add_argument('--max_search_iter', type=int, default=100,
    ...
    parser.add_argument('--lr_scheduler_lambda', type=float, default=0.95,
                        help='optimzier learning rate scheduler with lambda scheduler')
    ...
    parser.add_argument('--num_envs', type=int, default=1,
                        help='num of environments')
    parser.add_argument('--anneal_lr', type=str2bool, default=False,
                        help='is learning annealing')
    ...
    parser.add_argument('--clip_vloss', type=str2bool, default=True,
                        help='using clipped value loss')
    parser.add_argument('--max_grad_norm', type=float, default=0.5,
                        help='maximum norm for gradient clipping')
    parser.add_argument('--target_kl', type=float, default=None,
                        help='target KL divergence threshold')
    parser.add_argument('--ent_coef', type=float, default=0.0,
                        help='coeeficient for entorpy')
    parser.add_argument('--vf_coef', type=float, default=0.5,
                        help='coefficient for value function')

    # parser.add_argument('--minibatch_size', type=int, default=)

#########################################################
    parser.add_argument('--number_eval_arches', type=int, default=5,
                        help='number of evaluation arches')
